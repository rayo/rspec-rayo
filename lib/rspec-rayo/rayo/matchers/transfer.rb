RSpec::Matchers.define :be_a_valid_transfer_event do
  match_for_should do |event|
    basic_validation event, Punchblock::Rayo::Event::Complete, true do
      match_type event.reason, Punchblock::Rayo::Command::Tropo::Transfer::Complete::Success
    end
  end
...
RSpec::Matchers.define :be_a_valid_transfer_timeout_event do
  match_for_should do |event|
    basic_validation event, Punchblock::Rayo::Event::Complete, true do
      match_type event.reason, Punchblock::Rayo::Command::Tropo::Transfer::Complete::Timeout
    end
  end
