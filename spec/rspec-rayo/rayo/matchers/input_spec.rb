...
describe "Rayo Input matchers" do
  describe "an input complete event" do
    ...
    describe "that's successful" do
      let :reason do
        Punchblock::Rayo::Component::Input::Complete::Success.new.tap do |success|
    ...
    describe "that got no input" do
      let(:reason) { Punchblock::Rayo::Component::Input::Complete::NoInput.new }
      it { should be_a_valid_input_noinput_event }
    end

    describe "that got no match" do
      let(:reason) { Punchblock::Rayo::Component::Input::Complete::NoMatch.new }
